...
build_methodology_sheet <- function(
  ...
  sheet_rows <- tibble::tribble(
    ...
    "diccionario_variables", "adquisiciones_importadas", "original_transformada", "Resultados", "Adquisiciones importadas de activos fijos en maquinaria/equipos cuando la fuente las publica.", "EAAE; en subramas se extrae directamente de cuadros FBKF fuente y en constantes se divide por deflactor_2005.",
    "diccionario_variables", "adquisiciones_origen_importado", "original_transformada", "Resultados", "Adquisiciones en plaza de origen importado cuando la fuente las publica.", "EAAE; en subramas se extrae directamente de cuadros FBKF fuente y en constantes se divide por deflactor_2005.",
    ...
    "diccionario_variables", "metodo_fbkf_eaae", "trazabilidad", "eaae", "Método usado para cargar FBKF, maquinaria/equipos y adquisiciones.", "Desde 20260819, las subramas usan extracción directa de cuadros fuente; no prorrateo por VAB.",
    "diccionario_variables", "calidad_fbkf_eaae", "trazabilidad", "eaae", "Marca de calidad de las variables de FBKF/adquisiciones.", "Directo, directo agregado o sin dato fuente según nivel/año.",
    "diccionario_variables", "codigos_fbkf_fuente", "trazabilidad", "eaae", "Códigos de división fuente usados para homologar FBKF/adquisiciones subramales.", "Helper eaae_subrama_fbkf_direct.py.",
    "diccionario_variables", "archivos_fbkf_fuente", "trazabilidad", "eaae", "Archivos XLS fuente usados para extraer FBKF/adquisiciones subramales.", "Helper eaae_subrama_fbkf_direct.py.",
    "diccionario_variables", "n_filas_fbcf_fuente", "trazabilidad", "eaae", "Cantidad de filas fuente agregadas para FBCF/adquisiciones en el grupo homologado.", "Auditoría de extracción directa FBKF subrama.",
    "diccionario_variables", "n_filas_fbkf_maq_eq_fuente", "trazabilidad", "eaae", "Cantidad de filas fuente agregadas para el componente maquinaria/equipos en el grupo homologado.", "Auditoría de extracción directa FBKF subrama.",
