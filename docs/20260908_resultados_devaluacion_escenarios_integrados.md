...
Fuente de trabajo: `data/analysis-data/20260908_panel_eaae_2020_2024_industria_escenario_devaluacion.xlsx`, hojas `escenario-inicial`, `tipo-cambio`, `Escenario 1 - Comercio Exterior` y `Escenario 2 - Bienes Transables`.
...
![Brecha cambiaria modelada](../output/figures/devaluacion_escenarios_integrados_20260908/00_factor_devaluacion_2020_2024.png)
...
![Coeficientes de incidencia sobre la masa de ganancia](../output/figures/devaluacion_escenarios_integrados_20260908/00_coeficientes_incidencia_masa_ganancia.png)
...
![Gráfico 2. Monto apropiado/cedido según componente](../output/figures/devaluacion_escenarios_integrados_20260908/01_comercio_exterior_monto_apropiado_cedido_componentes_2024.png)

![Gráfico 3. Delta total sobre ganancia escenario inicial](../output/figures/devaluacion_escenarios_integrados_20260908/02_comercio_exterior_delta_total_ganancia_inicial.png)
...
![Gráfico 2. Monto apropiado/cedido según componente](../output/figures/devaluacion_escenarios_integrados_20260908/01_bienes_transables_monto_apropiado_cedido_componentes_2024.png)

![Gráfico 3. Delta total sobre ganancia escenario inicial](../output/figures/devaluacion_escenarios_integrados_20260908/02_bienes_transables_delta_total_ganancia_inicial.png)
...
El XLSX fuente mantiene otros campos para trazabilidad del modelo, pero los resultados principales de esta minuta se restringen a la masa de ganancia a precios básicos y a los cuatro deltas solicitados. La tasa de ganancia se reporta únicamente como gráfico complementario con la fórmula original 20260828.
