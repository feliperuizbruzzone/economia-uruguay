...
Fuente de trabajo: `data/analysis-data/20260830_panel_eaae_2020_2024_industria_escenario_devaluacion.xlsx`, hojas `escenario-inicial`, `tipo-cambio`, `Escenario 1 - Comercio Exterior` y `Escenario 2 - Bienes Transables`.
...
![Brecha cambiaria modelada](../output/figures/devaluacion_escenarios_integrados_20260830/00_factor_devaluacion_2020_2024.png)
...
![Coeficientes de incidencia por escenario y segmento](../output/figures/devaluacion_escenarios_integrados_20260830/00_coeficientes_incidencia_escenarios.png)
...
![Esquema TCC-TCP: cesión y apropiación](../output/figures/devaluacion_escenarios_integrados_20260830/00_esquema_efecto_tcc_tcp.png)
...
![Industria total: saldo de ganancia asociado a la sobrevaluación](../output/figures/devaluacion_escenarios_integrados_20260830/01_industria_total_saldo_sobrevaluacion_ganancia.png)
...
![Delta de ganancia del momento 2 como proporción de la ganancia inicial por sección](../output/figures/devaluacion_escenarios_integrados_20260830/01b_saldo_pct_ganancia_inicial_por_seccion.png)
...
El gráfico siguiente desagrega el saldo de la industria total por componente y lo expresa como porcentaje de la ganancia inicial. Esto permite comparar el peso relativo de VBP, costos, intereses y stock imputado en ambos escenarios.

![Industria total: componentes del saldo sobre ganancia inicial en 2024](../output/figures/devaluacion_escenarios_integrados_20260830/02_industria_total_componentes_saldo_pct_ganancia_2024.png)
...
![Escenario 1: saldo de ganancia por segmento](../output/figures/devaluacion_escenarios_integrados_20260830/03_comercio_exterior_saldo_ganancia_segmentos.png)
...
![Escenario 1: delta relativo de ganancia del momento 2](../output/figures/devaluacion_escenarios_integrados_20260830/03b_comercio_exterior_saldo_pct_ganancia_inicial_segmentos.png)
...
El gráfico de componentes sigue la lógica del chequeo del libro XLSX: cada delta se expresa en relación con la ganancia inicial de la sección. Se incluye el stock imputado para transparentar su efecto sobre el capital adelantado, aunque no entre en la masa absoluta de ganancia.

![Escenario 1: componentes del saldo sobre ganancia inicial en 2024](../output/figures/devaluacion_escenarios_integrados_20260830/04_comercio_exterior_componentes_saldo_pct_ganancia_2024_segmentos.png)
...
![Escenario 2: saldo de ganancia por segmento](../output/figures/devaluacion_escenarios_integrados_20260830/03_bienes_transables_saldo_ganancia_segmentos.png)
...
![Escenario 2: delta relativo de ganancia del momento 2](../output/figures/devaluacion_escenarios_integrados_20260830/03b_bienes_transables_saldo_pct_ganancia_inicial_segmentos.png)
...
El gráfico de componentes replica la lectura del chequeo: VBP aparece con signo negativo cuando representa ganancia dejada de percibir bajo sobrevaluación, mientras costos, intereses y stock imputado aparecen con signo positivo cuando representan ahorro o apropiación relativa bajo sobrevaluación.

![Escenario 2: componentes del saldo sobre ganancia inicial en 2024](../output/figures/devaluacion_escenarios_integrados_20260830/04_bienes_transables_componentes_saldo_pct_ganancia_2024_segmentos.png)
...
El coeficiente de stock de capital imputado se mantiene en el XLSX porque afecta cálculos de tasa de ganancia. En los gráficos de componentes se lo incluye como delta relativo contra la ganancia inicial para mantener consistencia con el chequeo, pero no debe sumarse a la masa absoluta de ganancia: su lugar conceptual es el capital adelantado.
